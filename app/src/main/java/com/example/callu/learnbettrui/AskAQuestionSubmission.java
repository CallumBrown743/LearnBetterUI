...
import com.example.callu.learnbettrui.MyDownloadService;
import com.example.callu.learnbettrui.MyUploadService;
 ...
 */
public class AskAQuestionSubmission extends AppCompatActivity implements View.OnClickListener {
    Intent qStuff = new Intent(this, showQuestion.class);
    @Override
    public void startActivity(Intent qStuff) {
        super.startActivity(qStuff);
    }
